    ...
    <div class="container mt-5">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="../bahan1/vivo/x80 pro/1.png" class="d-block w-100" alt="Slide 1">
        </div>
        <div class="carousel-item">
          <img src="../bahan1/vivo/x80 pro/2.png" class="d-block w-100" alt="Slide 2">
        </div>
        <div class="carousel-item">
          <img src="../bahan1/vivo/x80 pro/3.png" class="d-block w-100" alt="Slide 3">
        </div>
      </div>
      ...
      <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
        ...
        <div class="col-md-4">
  <h2 class="product-title">Vivo X80 Pro</h2>
  <p class="product-description">Deskripsi Produk</p>
  <p>RAM 12/512<br>Chipset mediatek Dimensity 9000<br>Layar Super Amoled</p>
</div>
<div class="col-md-4">
  <h3 class="product-price">Harga: $779</h3>
 
  <a href="pembayaran.php?product=2" class="btn btn-dark">Beli Produk</a>
</div>
