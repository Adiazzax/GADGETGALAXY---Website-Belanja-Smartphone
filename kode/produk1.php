    ...
    <div class="container mt-5">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="../bahan1/realme/gt neo 2/1.png" class="d-block w-100" alt="Slide 1">
        </div>
        <div class="carousel-item">
          <img src="../bahan1/realme/gt neo 2/2.png" class="d-block w-100" alt="Slide 2">
        </div>
        <div class="carousel-item">
          <img src="../bahan1/realme/gt neo 2/3.png" class="d-block w-100" alt="Slide 3">
        </div>
      </div>
      ...
      <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
        ...
        <div class="col-md-4">
  <h2 class="product-title">Realme GT Neo 2</h2>
  <p class="product-description">Deskripsi Produk</p>
  <p>RAM 8/512<br>Chipset Sanpdragon 8+ gen 1<br>Layar Super Amoled</p>
</div>
<div class="col-md-4">
  <h3 class="product-price">Harga: $599</h3>

<a href="pembayaran.php?product=1" class="btn btn-dark">Beli Produk</a>
</div>
