...
<html>
  <head>
    <title>Samsung Galaxy ZFlip4</title>
    ...
    <div class="container mt-5">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="../bahan1/samsung/zflip4/4.png" class="d-block w-100" alt="Slide 1">
        </div>
        <div class="carousel-item">
          <img src="../bahan1/samsung/zflip4/2.png" class="d-block w-100" alt="Slide 2">
        </div>
        <div class="carousel-item">
          <img src="../bahan1/samsung/zflip4/3.png" class="d-block w-100" alt="Slide 3">
        </div>
      </div>
      ...
      <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
        ...
        <div class="col-md-4">
  <h2 class="product-title">Samsung Galaxy ZFlip4</h2>
  <p class="product-description">Deskripsi Produk</p>
  <p>RAM 8/512<br>Chipset Snapdragon 8+ Gen 2<br>Layar Super Amoled Flip</p>
</div>
<div class="col-md-4">
  <h3 class="product-price">Harga: $1299</h3>
  <a href="pembayaran.php?product=5" class="btn btn-dark">Beli Produk</a>
</div>
      </div>
    </div>
